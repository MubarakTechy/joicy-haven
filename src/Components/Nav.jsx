  ...
  return (
    <div>
        <nav className='w-[100%] flex fixed items-center justify-between px-[40px] bg-[#D9D9D9] text-black z-10 h-[10vh]'>
            ...
            <button className='border-2 border-purple-500 px-[20px] bg-white rounded-lg text-black py-[12px] w-[13vw] font-semibold'><Link href={'/Appointmentpage'}>Book Now</Link></button>
            </ul>
